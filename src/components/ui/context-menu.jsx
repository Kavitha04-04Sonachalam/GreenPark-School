...
const ContextMenuSubTrigger = /*#__PURE__*/React.forwardRef(
  ...
  _jsxs(ContextMenuPrimitive.SubTrigger, {
    ref: ref,
    className: cn(
...
const ContextMenuSubContent = /*#__PURE__*/React.forwardRef(
  ...
  _jsx(ContextMenuPrimitive.SubContent, {
    ref: ref,
    className: cn(
...
const ContextMenuContent = /*#__PURE__*/React.forwardRef(
  ...
  ({ className, ...props }, ref) => /*#__PURE__*/
  _jsx(ContextMenuPrimitive.Portal, { children: /*#__PURE__*/
    _jsx(ContextMenuPrimitive.Content, {
      ref: ref,
      className: cn(
...
const ContextMenuItem = /*#__PURE__*/React.forwardRef(
  ...
  _jsx(ContextMenuPrimitive.Item, {
    ref: ref,
    className: cn(
...
const ContextMenuCheckboxItem = /*#__PURE__*/React.forwardRef(
  ...
  _jsxs(ContextMenuPrimitive.CheckboxItem, {
    ref: ref,
    className: cn(
    ...
    _jsx("span", { className: "absolute left-2 flex h-3.5 w-3.5 items-center justify-center", children: /*#__PURE__*/
      _jsx(ContextMenuPrimitive.ItemIndicator, { children: /*#__PURE__*/
...
const ContextMenuRadioItem = /*#__PURE__*/React.forwardRef(
  ...
  _jsxs(ContextMenuPrimitive.RadioItem, {
    ref: ref,
    className: cn(
      'relative flex cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
      className
    ...
    _jsx("span", { className: "absolute left-2 flex h-3.5 w-3.5 items-center justify-center", children: /*#__PURE__*/
      _jsx(ContextMenuPrimitive.ItemIndicator, { children: /*#__PURE__*/
        _jsx(Circle, { className: "h-2 w-2 fill-current" }) }
      ) }
    ),
    children] }
  )
...
const ContextMenuLabel = /*#__PURE__*/React.forwardRef(
  ...
  ({ className, inset, ...props }, ref) => /*#__PURE__*/
  _jsx(ContextMenuPrimitive.Label, {
    ref: ref,
    className: cn(
...
const ContextMenuSeparator = /*#__PURE__*/React.forwardRef(
  ...
  ({ className, ...props }, ref) => /*#__PURE__*/
  _jsx(ContextMenuPrimitive.Separator, {
    ref: ref,

...
import { jsx as _jsx, jsxs as _jsxs, Fragment as _Fragment } from "react/jsx-runtime";const THEMES = { light: '', dark: '.dark' };
...
const ChartContainer = /*#__PURE__*/React.forwardRef(
  ...
  ({ id, className, children, config, ...props }, ref) => {
    ...
    return (/*#__PURE__*/
      _jsx(ChartContext.Provider, { value: { config }, children: /*#__PURE__*/
        _jsxs("div", {
          "data-chart": chartId,
          ref: ref,
          className: cn(
          ...
          _jsx(ChartStyle, { id: chartId, config: config }), /*#__PURE__*/
...
const ChartTooltipContent = /*#__PURE__*/React.forwardRef(
  ...
  ref) =>
  {
    ...
    const tooltipLabel = React.useMemo(() => {
      ...
      return /*#__PURE__*/_jsx("div", { className: cn('font-medium', labelClassName), children: value });
    }, [
    label,
    labelFormatter,
    payload,

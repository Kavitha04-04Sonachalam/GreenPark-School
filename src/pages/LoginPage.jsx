...
import { LogIn, Mail, Phone, MapPin, Facebook, Youtube, Linkedin, Instagram } from 'lucide-react'
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200">
            ...
            <div className="bg-gradient-to-r from-schoolGreen to-green-700 text-white p-6 text-center">
              <h2 className="text-2xl font-bold">Parent Portal Login</h2>
              <p className="text-green-100 text-sm mt-1">Access your child's information</p>
            </div>
